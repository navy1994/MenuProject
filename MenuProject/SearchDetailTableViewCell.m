...
//        _tipsLB.font = [UIFont boldSystemFontOfSize:14];
//        
//        [self.contentView addSubview:_tipsLB];
//        
//        self.stepLB = [UILabel new];
//        _stepLB.text = @"步骤图";
//        _stepLB.font = [UIFont boldSystemFontOfSize:12];
...
//        _browseLB.font = [UIFont boldSystemFontOfSize:13];
...
//        _collectLB.font = [UIFont boldSystemFontOfSize:13];
...
//            make.bottom.equalTo(self.tipsLB.mas_top).with.offset(-10);
//        }];
//        
...
//            make.bottom.equalTo(self.browseLB.mas_top).with.offset(-10);
//        }];
//        
//        [_browseLB mas_makeConstraints:^(MASConstraintMaker *make){
//            make.top.equalTo(self.tipsLB.mas_bottom).with.offset(10);
//            make.left.equalTo(self.imageView.mas_right).with.offset(10);
//            make.right.equalTo(self.collectLB.mas_left).with.offset(-5);
//            make.bottom.equalTo(self.contentView).with.offset(-10);
...
//        tags.font = [UIFont boldSystemFontOfSize:13];
//        [self.contentView addSubview:tags];
//        
//        imageView.frame = CGRectMake(10, 10, 100, 70);
//    
//        titleLabel.frame = CGRectMake(115, 10, screen_width-115, 30);
//        tags.frame = CGRectMake(115, 40, screen_width-115, 20);
    }
    return self;
}
